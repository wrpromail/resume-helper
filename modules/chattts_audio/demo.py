...
def main():
    ...
    if local_path is not None:
        chat.load_models(vocos_config_path=f"{local_path}/config/vocos.yaml",
                         vocos_ckpt_path=f"{local_path}/asset/Vocos.pt",
                         dvae_config_path=f"{local_path}/config/dvae.yaml",
                         dvae_ckpt_path=f"{local_path}/asset/DVAE.pt", 
                         gpt_config_path=f"{local_path}/config/gpt.yaml",
                         gpt_ckpt_path=f"{local_path}/asset/GPT.pt", 
                         decoder_config_path=f"{local_path}/config/decoder.yaml", 
                         decoder_ckpt_path=f"{local_path}/asset/Decoder.pt", 
                         tokenizer_path=f"{local_path}/asset/tokenizer.pt")
    else:
        chat.load_models()
